...
if platform == "darwin":
    ...
    file_path = "/home/graham/Dropbox/Graham/Data/Simulations/"
...
if __name__ == "__main__":
    ...
    if filename[-3:] != ".py":
        ...
        input_file = file_path + "1DHe/src/" + filename + ".cuh"
    else:
        module_name = filename[:-3]
        input_file = file_path + "1DHe/src/" + module_name + ".cuh"
else:
